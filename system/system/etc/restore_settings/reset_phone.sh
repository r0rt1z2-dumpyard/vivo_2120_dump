...
rm /data/misc/apexdata/com.android.wifi/WifiConfigStore.xml  # zhangtaorjyb add for wifi AndroidR
...
rm /data/misc/apexdata/com.android.wifi/WifiConfigStoreSoftAp.xml  # zhangtaorjyb add for wifiap AndroidR
...
#add by xiejiyuan for vrt begin
rm -rf /data/vusbd/*
#add by xiejiyuan for vrt end
